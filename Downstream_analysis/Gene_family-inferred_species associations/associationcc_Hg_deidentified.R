...
Socioprocessing[54,4] <- NUMBER #PARTICIPANT_ID at delivery
Socioprocessing[45,4] <- NUMBER #PARTICIPANT_ID at delivery
...
write.table(input_data_phy, file = "input_data_gene_all.tsv", sep="\t")
write.table(input_metadata_phy, file = "input_metadata_phy_all.tsv", sep="\t")
