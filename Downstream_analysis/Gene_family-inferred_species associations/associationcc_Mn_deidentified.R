...
#outlier removed, high metal concentration in accordance with taxa screen.
...
write.table(input_data_phy, file = "input_data_gene.tsv", sep="\t")
write.table(input_metadata_phy, file = "input_metadata_gene.tsv", sep="\t")
