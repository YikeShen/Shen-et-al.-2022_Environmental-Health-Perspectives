...
write.table(input_data_phy, file = "input_data_gene_mc.tsv", sep="\t")
write.table(input_metadata_phy, file = "input_metadata_phy_mc.tsv", sep="\t")
...
write.table(FDRq_Mn, file = "FDRq_Mn.tsv", sep="\t")
