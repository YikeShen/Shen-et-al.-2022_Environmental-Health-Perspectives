...
importantcov[11,4] <- NUMBER #participantID
importantcov[16,4] <- NUMBER #participantID
importantcov[32,4] <- NUMBER #participantID, NA fron Y6 impute with median
importantcov[35,4] <- NUMBER #participantID
importantcov[62,4] <- NUMBER #participantID
importantcov[82,4] <- NUMBER #participantID, NA from Y6 impute with median
...
Socioprocessing <- Socioprocessing[!(Socioprocessing$SampleID %in% "2336"), ]
...
write.table(input_data_phy, file = "input_data_gene_Pb_mc.tsv", sep="\t")
write.table(input_metadata_phy, file = "input_metadata_Pb_mc.tsv", sep="\t")


#"Delivery_mode","BMI_delivery","Delivery_mode","DiagnoseIndex_prgnancy","DiagnoseIndex_preexisting","Sex","Family_Income"
